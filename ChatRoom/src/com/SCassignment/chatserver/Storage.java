...
public class Storage {
	...
	static ConcurrentHashMap<Integer,Set<Integer>> clients = new ConcurrentHashMap<Integer,Set<Integer>>();	//Stores which client id belongs to which chat room ::	||ClientID|ChatroomID||
